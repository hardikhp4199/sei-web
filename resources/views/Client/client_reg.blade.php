...
<div class="wrapper ovh">
    ...
    <div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto px-0">
            <div class="d-flex align-items-center">
                ...
                <a class="ud-btn btn-thm2 add-joining" href="{{ url('client/login') }}">Sign In</a>
            </div>
        </div>
    </div>
</div>
  ...
  <section class="our-login">
        ...
        <div class="row align-items-center">
          ...
          <h2 class="title">Sign Up</h2>
              ...
              <div class="mb30">
                ...
                <p class="text mt20">Already have an account? <a href="{{ route('client.login') }}" class="text-thm">Log In!</a></p>
              </div>
              
              <form method="POST" action="{{ route('client.cli_register') }}">
    @csrf
    <div class="mb25">
        <label class="form-label fw500 dark-color">Username</label>
        <input type="text" name="username" class="form-control" placeholder="User Name" maxlength="15" required>
    ...
    <div class="mb15">
        ...
        <input type="password" name="password_confirmation" class="form-control" placeholder="***" maxlength="10" required>
