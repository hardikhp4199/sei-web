...
@include('Client.layouts.shared.head-css')
</head>
<body>
<div class="wrapper">
...
<div class="content-page">
                <div class="content">
                    ...
                    @include('Client.layouts.shared.page-title')
<div class="row">
...
@include('Client.layouts.shared.footer-scripts')

<script src="{{ asset('client/js/vendor/apexcharts.min.js') }}"></script>
<script src="{{ asset('client/js/vendor/moment.min.js') }}"></script>
<script src="{{ asset('client/js/vendor/daterangepicker.js') }}"></script>
<script src="{{ asset('client/js/vendor/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ asset('client/js/vendor/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('client/js/pages/demo.dashboard.js') }}"></script>
</body>
</html>