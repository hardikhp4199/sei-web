    ...
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <div class="logo-topbar">
                <!-- Logo light -->
                <a href="{{route('expert.index')}}" class="logo-light">
                    <span class="logo-lg">
                ...
                <!-- Logo Dark -->
                <a href="{{route('expert.index')}}" class="logo-dark">
                    <span class="logo-lg">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
                    ...
                    <span class="noti-icon-badge badge text-bg-pink">1</span>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                    <div class="p-2 border-top-0 border-start-0 border-end-0 border-dashed border">
                        <div class="row align-items-center">
                    ...
                    <div style="max-height: 300px;" data-simplebar>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            ...
                            <p class="notify-details">You have no notification...
        ...
        <i class="ri-arrow-down-s-line d-none d-sm-inline-block align-middle"></i>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <div class=" dropdown-header noti-title">
                        <h6 class="text-overflow m-0">Welcome &nbsp; {{ session('username') }} ! </h6>
                    </div>

                    <!-- item-->
                    <a href="{{ route('expert.profile') }}" class="dropdown-item">
