...
<nav class="nxl-navigation">
    ...
    <div class="card stretch stretch-full">
        <div class="card-body">
            <div class="row">
                    ...
                    <table class="table table-bordered overflow-hidden" id="tab_logic">
                        ...
                        <tbody>
                            <tr id="addr0">
                                ...
                                <td><input type="date" name="date[]" id="startDate" placeholder="Start Date" class="form-control date"></td>
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                    <button id="delete_row" class="btn btn-md bg-soft-danger text-danger">Delete</button>
                    <button id="add_row" class="btn btn-md btn-primary">Add Milestone</button>
                </div>
                <div class="d-flex justify-content-end gap-2 mt-3">
    ...
    $("#add_row").click(function(){
        var newRow = `<tr id="addr${i}">
            <td>${i + 1}</td>
            <td>
                <select name="services[${i}][service_id]" class="form-control">
                    @foreach($services as $service)
                        <option value="{{ $service->id }}">{{ $service->ServiceName }}</option>
                    @endforeach
                </select>
            </td>
            <td><input type="number" name="services[${i}][qty]" placeholder="Qty" class="form-control qty"></td>
            <td><input type="number" name="services[${i}][price]" placeholder="Unit Price" class="form-control price"></td>
            <td>
                <select name="services[${i}][hourly]" class="form-control">
                    <option value="Hourly">Hourly</option>
                    <option value="Day">Day</option>
                    <option value="fixed">Fixed</option>
                </select>
            </td>
            <td><input type="number" name="services[${i}][total]" placeholder="0.00" class="form-control total" readonly></td>
        </tr>`;
    ...
    function calculateTotal() {
        ...
        // Additional logic to apply discounts and tax
    }
